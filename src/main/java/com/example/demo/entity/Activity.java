...
public class Activity {
    ...
    private String date;
    private String status;          // IDEA, PLANNED, or COMPLETED
    private int ratingRehema;       // 0–5, Rehema's rating
    private int ratingCollins;      // 0–5, Collins' rating
    private String completedAt;     // ISO-8601 timestamp, set when status becomes COMPLETED

    public Activity() {}

    public Activity(String title, String description, String date,
                    String status, int ratingRehema, int ratingCollins, String completedAt) {
        this.title = title;
